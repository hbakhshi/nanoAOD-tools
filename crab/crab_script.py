...
elif len(II)>0 and 'Run2018' in II[0]:
...
print "Inside crab_script.py"
print II
print ["." , II , None, None, None, 'LZMA:9',
       '{0}/python/PhysicsTools/NanoAODTools/postprocessing/vbfgamma/keep_and_drop.txt'.format(os.environ['CMSSW_BASE']),
       None, modules_ , False, False, False,
       0, False, False,
       True,True,runsAndLumis() ]
